                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type" id="type">
                                            <option value="package" @if ($item->type=='package') selected @endif>بسته</option>
                                            <option value="user" @if ($item->type=='user') selected @endif>کاربر</option>
                                            <option value="sms" @if ($item->type=='sms') selected @endif>پیامک</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6">
