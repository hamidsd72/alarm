                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            {{ Form::open(array('route' => 'admin.about.store', 'method' => 'POST', 'files' => true)) }}
                            <div class="row">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('title_home',null, array('class' => 'form-control', 'required' => 'required')) }}
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        {{ Form::label('full_name', 'نام کامل متصدی فروشگاه') }}
                                        {{ Form::text('full_name', $item->first_name.' '.$item->last_name, array('class' => 'form-control', 'required' => 'required')) }}
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="exampleInputFile" name="pic_home" accept=".jpg,.png" , required>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {{ Form::textarea('text_home',null, array('class' => 'form-control textarea', 'required' => 'required')) }}
                                    </div>
                                </div>
                            ...
                            <br/>
                            <div class="col-6">
                                {{ Form::button('ثیت', array('type' => 'submit', 'class' => 'btn btn-success col-12')) }}
                            </div>
                            <div class="col-6">
