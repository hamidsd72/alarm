...
Route::resource('task-master', 'TaskMasterController');
Route::resource('leave-day', 'LeaveDayController');
Route::get('leave-day/force/delete/{id}', 'LeaveDayController@destroy')->name('leave-day.force.delete');
