...
class ServicePackage extends Model {
    ...
    {
        return $this->belongsTo('App\Model\Job','title')->first('title');
    }
    public function job()
    {
        return $this->hasMany('App\Model\JobReport','job_id');
    }
    public function jobTime()
    {
        return $this->hasMany('App\Model\JobReport','job_id')->sum('time');
    }
    public function jobTodayTime()
    {
        return $this->hasMany('App\Model\JobReport','job_id')->where('created_at', '>', Carbon::now()->startOfDay())->sum('time');
    }
    public function jobRuning()
    {
        return $this->hasMany('App\Model\JobReport','job_id')->where('status', 'start');
    }
    ...
    {
        return $this->belongsTo('App\Model\Agent','custom')->first();
    }
